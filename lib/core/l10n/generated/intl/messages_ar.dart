...
class MessageLookup extends MessageLookupByLibrary {
  ...
  static Map<String, Function> _notInlinedMessages(_) => <String, Function>{
        ...
        "newestBooks": MessageLookupByLibrary.simpleMessage("أحدث الكتب"),
        "preview": MessageLookupByLibrary.simpleMessage("معاينة"),
        "search": MessageLookupByLibrary.simpleMessage("ابحث"),
        "searchQuery": MessageLookupByLibrary.simpleMessage(
            "من فضلك، اكتب ما الذي تبحث عنه."),
        "searchResult": MessageLookupByLibrary.simpleMessage("نتائج البحث"),
        "similarBooks":
            MessageLookupByLibrary.simpleMessage("يمكن أيضا أن تعجبك")
      };
}
